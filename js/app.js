...
let slider_about = new Swiper('.coffee__swiper', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
...
//    mouseY = e.pageY;
// });
let slideCoffee = document.querySelector('.coffee__slide');
// let activePrev = document.querySelector('.coffee__item_prev');
let slidePrev = document.querySelector('.swiper-slide-prev');

if (!slideCoffee.classList.contains('.coffee__item_prev')) {
   activePrevo.classList.add('active');
};
